...
export const arroyoVistaDemoEvidence: readonly DemoEvidence[] = [
  ...
  { key:"energy", evidence_type:"document", title:"DEMO — Energy compliance package", summary:"Fictional client-provided CF1R and supporting energy calculations are labeled for the revised ADU scope. Agency acceptance is not independently confirmed.", source_url:"https://client-files.demo-permitpulse.example/arroyo-vista/energy-compliance-revised.pdf", source_label:"Client-provided demo file", source_date:"2026-05-14", verification_status:"verified" },
  { key:"client-inquiry", evidence_type:"email", title:"DEMO — Client status inquiry", summary:"Fictional client email asks whether the revised package returned to the original reviewer and whether any additional fee or form remains outstanding.", source_url:"https://client-messages.demo-permitpulse.example/arroyo-vista/status-inquiry-2026-05-27", source_label:"Client-provided email summary", source_date:"2026-05-27", verification_status:"verified" },
  { key:"reviewer-email", evidence_type:"email", title:"DEMO — Reviewer routing email note", summary:"Fictional email note says intake was completed and routing would follow, but the copied note omits the original message headers and final recipient list.", source_url:"https://records.demo-ladbs.example/permits/DEMO-LADBS-2026-1842/routing-email-2026-05-20", source_label:"LADBS Demo routing email record", source_date:"2026-05-20", verification_status:"verified" },
  ...
  { key:"analyst", evidence_type:"other", title:"DEMO — Internal analyst chronology note", summary:"Fictional analyst note reconciles the correction, upload, and intake dates and identifies reviewer assignment as the narrow unresolved issue. This is analysis, not an agency determination.", source_url:"https://analysis.demo-permitpulse.example/arroyo-vista/chronology-2026-05-29", source_label:"PermitPulse internal demo analysis", source_date:"2026-05-29", verification_status:"verified" },
] as const;
...
export const arroyoVistaDemoTimeline: readonly DemoTimeline[] = [
  ...
  { key:"intake", occurred_on:"2026-05-20", timeline_type:"status_update", title:"DEMO — Intake receipt acknowledged", details:"A fictional routing note indicates intake completion, but reviewer assignment is not shown.", is_canonical:true, evidence_keys:["receipt","reviewer-email"] },
...
export const arroyoVistaDemoActionKit = {
  ...
  evidence_readiness:"Ready for follow-up: all nine verified evidence records are indexed with complete source details.",
